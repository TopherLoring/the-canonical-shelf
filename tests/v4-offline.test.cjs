...
assert.ok(sw.includes('./v4-shell-bridge.js'),'full-shell v4 integration bridge must be available offline');
...
console.log(`PASS v4 offline cache: preview + ${assets.length} local runtime assets + full-shell bridge are precached`);
