...
(() => {
  ...
  const STYLES = ['v4-design-system.css','v4-integrated.css','v5-shell.css','v5-pages.css','v5-mobile-bible.css'];
  const FILES = [
    ...
    'v4-app-integrated.js','v4-shell-bridge.js','v5-shell.js','v5-pages.js','v5-book-study-data.js','v5-mobile-bible.js'
  ];
