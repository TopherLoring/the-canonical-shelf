const CACHE="canon-v4-redesign-3";
const ASSETS=[
  ...
  "./topics-data.js","./topics-extended.js","./v4-topic-bridge.js","./topics.js","./v4-topics-enhance.js","./v4-app-integrated.js",
  "./v4-loader-final.js","./v4-loader-complete.js",
...
self.addEventListener("activate",e=>{
  e.waitUntil(caches.keys().then(ks=>Promise.all(ks.filter(k=>k.startsWith("canon-")&&k!==CACHE).map(k=>caches.delete(k)))).then(()=>self.clients.claim()));
});
self.addEventListener("fetch",e=>{
  ...
  e.respondWith(caches.match(e.request).then(hit=>hit||fetch(e.request).then(r=>{
    ...
    if(e.request.mode==="navigate"){
      ...
      const page=await caches.match(fallback);if(page)return page;
    }
